...
public class frmCadastro extends javax.swing.JDialog
{
    ...
    {//GEN-HEADEREND:event_btnCadastrarActionPerformed
        ...
        List<String> ListaDadosToys = new ArrayList<>();
        ListaDadosToys.add("0");
        ListaDadosToys.add(txfMarca.getText());
        ListaDadosToys.add(txfNome.getText());
        ListaDadosToys.add(txfPreco.getText());
        controle.Cadastrar(ListaDadosToys);
